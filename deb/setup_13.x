...
#   https://github.com/nxpkg/distributions
#
...
# https://github.com/nxpkg/distributions/tree/master/deb/src
...
${bold}${NODENAME} is no longer actively supported!${normal}
  ...
  distributions. To learn more about usage, see the repository:
    ${bold}https://github.com/nxpkg/distributions${normal}
"
        echo
...
if [[ $IS_PRERELEASE -eq 0 ]]; then
    print_status "Your distribution, identified as \"$(lsb_release -d -s)\", is a pre-release version of Ubuntu. NodeSource does not maintain official support for Ubuntu versions until they are formally released. You can try using the manual installation instructions available at https://github.com/nxpkg/distributions and use the latest supported Ubuntu version name as the distribution identifier, although this is not guaranteed to work."
    exit 1
fi
...
if [[ $RC != 0 ]]; then
    print_status "Your distribution, identified as \"${DISTRO}\", is not currently supported, please contact NodeSource at https://github.com/nxpkg/distributions/issues if you think this is incorrect or would like your distribution to be considered for support"
    exit 1
fi
